...
function App() {
  ...
  return (
    <div className="w-full h-full overflow-auto">
      <div className="w-full h-full bg-futuristic bg-cover bg-center flex flex-col px-20">
        <div className="w-full flex justify-between text-white py-8">
          <div className="font-bold text-2xl">
            Portfolio
          </div>
          <div className="flex flex-row text-white text-sm">
            <div className="mx-2 cursor-pointer hover:text-yellow-500" onClick={() => handleClick(aboutRef)}>
              Hakkımda
            </div>
            ...
            <div className="mx-2 cursor-pointer hover:text-yellow-500" onClick={() => handleClick(contactRef)}>
              İletişim
            </div>
          </div>
        </div>
